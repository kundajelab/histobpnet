...
python /home/valehvpa/projects/scCisTrans/histobpnet/scripts/train/main.py \
    ...
    --bigwig /large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/reads_to_bigwig/instance-20251010_144803/unstranded.bw \
...
# Namespace(output_dir='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/training', fast_dev_run=False, name='chrombpnet_train_k562_lei_compare_seed_ev', command='train', gpu=[0], chrom='test', bias_scaled='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/pretrained/ENCSR467RSV/fold_0/model.bias_scaled.fold_0.ENCSR868FGK.h5', chrombpnet_wo_bias=None, checkpoint=None, verbose=False, alpha=76.2, cvd='1', lr=0.001, optimizer_eps=1e-07, skip_wandb=False, shap='counts', max_epochs=100, precision=32, gradient_clip=None, adjust_bias=True, model_type='chrombpnet', n_filters=512, n_layers=8, conv1_kernel_size=21, n_outputs=1, profile_output_bias=True, count_output_bias=True, out_dim=None, n_count_outputs=None, n_control_tracks=None, output_bins=None, profile_kernel_size=None, data_dir=None, peaks='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/lei_peaks_ss_40000.bed', negatives='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/negatives/lei_negatives_ss_40000.bed', bigwig='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/reads_to_bigwig/instance-20251010_144803/unstranded.bw', bigwig_ctrl=None, negative_sampling_ratio=0.1, saved_data=None, fasta='/large_storage/goodarzilab/valehvpa/refs/hg38/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta', chrom_sizes='/large_storage/goodarzilab/valehvpa/refs/hg38/hg38.chrom.sizes', fold=0, genome='hg38', in_window=2114, out_window=1000, atac_hgp_map=None, skip_missing_hist=False, ctrl_scaling_factor=1.0, outputlen_neg=None, shift=500, rc_frac=0.5, outlier_threshold=0.999, batch_size=64, num_workers=8, debug=False, run_pid=1116142) 

# Namespace(adjust_bias=True, alpha=76.2, batch_size=64, beta=1, bias_scaled='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/bias_model/ENCSR868FGK_bias_fold_0.h5', bigwig='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/lei_unstranded.bw', checkpoint=None, chrom='test', chrom_sizes=None, chrombpnet_wo_bias=None, command='train', conv1_kernel_size=21, count_output_bias=True, data_dir=None, data_type='profile', debug=False, dev=False, fast_dev_run=False, fasta='/large_storage/goodarzilab/valehvpa/refs/hg38/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta', fold=0, force=False, genome='hg38', gpu=[0], gradient_clip=None, in_window=2114, max_epochs=100, model_type='chrombpnet', n_control_tracks=0, n_filters=512, n_layers=8, n_outputs=1, name='', negative_sampling_ratio=0.1, negatives='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/negatives/lei_negatives_ss_40000.bed', num_workers=8, out_dim=1000, out_dir='output', out_window=1000, outlier_threshold=0.999, peaks='/large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/lei_peaks_ss_40000.bed', precision=32, profile_kernel_size=75, profile_output_bias=True, rc=0.5, run_pid=1120446, saved_data=None, shap='counts', shift=500, verbose=False, version=None)

# chrombpnet train --peaks /large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/lei_peaks_ss_40000.bed --negatives /large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/negatives/lei_negatives_ss_40000.bed --bigwig /large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/lei_unstranded.bw --bias /large_storage/goodarzilab/valehvpa/data/projects/scCisTrans/for_chrombpnet_tuto/bias_model/ENCSR868FGK_bias_fold_0.h5 --fasta /large_storage/goodarzilab/valehvpa/refs/hg38/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta --adjust_bias
